...
const experiences = [
  {
    type: 'Current Role',
    company: 'Arcgate Technologies, Udaipur',
    role: 'Research Analyst',
    period: 'May 2026 – Present',
    duration: 'Active',
    summary:
      'Working as a Research Analyst at Arcgate Technologies, Udaipur, with a focus on research support, dataset management, analytical reporting, and business intelligence to help drive practical business decisions.',
    highlights: [
      'Support research and analysis workflows by organizing data and improving reporting clarity.',
      'Prepare insights that help stakeholders understand trends, patterns, and key metrics quickly.',
      'Collaborate on data-driven tasks that improve decision-making and operational understanding.',
    ],
    achievements: [
      { metric: 'Research', description: 'Support' },
      { metric: 'May 2026', description: 'Joined' },
      { metric: 'Analytics', description: 'Focused Work' },
    ],
    tools: ['Research', 'Excel', 'SQL', 'Reporting', 'Data Analysis'],
  },
  {
    ...
    duration: 'Completed',
    summary:
      'Completed a data analytics internship focused on dataset management, analytical reporting, and business intelligence, contributing to practical business insights and reporting accuracy.',
    highlights: [
      'Clean and organize raw datasets to improve research quality, analysis clarity, and reporting accuracy.',
      'Prepare summary reports and dashboard-ready insights that make patterns easier to understand.',
      'Track trends, KPIs, and performance indicators to support research-backed and data-driven decisions.',
    ],
    achievements: [
...
const ExperienceSection = () => {
  return (
    <section id="experience" className="py-24 md:py-32 lg:py-40 bg-background">
        ...
        <ScrollReveal>
          <div className="text-center mb-16 md:mb-20">
            ...
            <p className="section-description">
              Internship experience and current role, both aligned with research and data analytics.
            </p>
          </div>
        </ScrollReveal>
          ...
          <ScrollReveal direction="left">
            <div className="space-y-6">
              {experiences.map((experience) => (
                <div
                  key={experience.type}
                  className={`rounded-2xl border section-card-surface p-8 md:p-10 shadow-elevated h-full interactive-card transition-all duration-300 hover:shadow-lifted ${
                    experience.type === 'Current Role'
                      ? 'border-primary/35 bg-gradient-to-br from-primary/10 via-white/70 to-white hover:border-primary/55'
                      : 'border-border/60 bg-white/55 hover:border-primary/40'
                  }`}
                >
                  <div className="flex flex-wrap items-center gap-3 mb-5">
                    <span className={`inline-flex items-center gap-2 rounded-full backdrop-blur-md px-4 py-2 text-sm font-medium border ${
                      experience.type === 'Current Role'
                        ? 'bg-primary text-primary-foreground border-primary/40'
                        : 'bg-white/60 text-primary border-primary/30'
                    }`}>
                      <Sparkles className={`h-4 w-4 ${experience.type === 'Current Role' ? 'text-primary-foreground' : 'text-primary'}`} />
                      {experience.duration}
                    </span>
                    <span className={`inline-flex items-center rounded-full backdrop-blur-md px-4 py-2 text-sm font-medium border ${
                      experience.type === 'Current Role'
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-2">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <span className={`w-fit rounded-full px-4 py-2 text-sm font-medium border ${
                            experience.type === 'Current Role'
